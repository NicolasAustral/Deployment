...
```{r, motivoDeIngreso, echo=FALSE, message=FALSE, warning=FALSE, out.width="50%"}
...
plot_ly(alpha = 1, color=mayoresA45Hombres$`MOTIVO DE INGRESO`, colors = c("#58FAD0","#01DF74","#088A68","#01DFA5", "#0B614B", "#0B2F3A", "#086A87", "#01A9DB","#2ECCFA","#A9BCF5","#0080FF")) %>%
  ...
  layout(barmode = "overlay",showlegend = F, title = "Reasons for admission for men over 45 years of age", xaxis = list(title = "Reasons for admission"), yaxis = list(title = "Amount of people", dtick=40))
